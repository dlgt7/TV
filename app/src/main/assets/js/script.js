...
const translations = {
    'zh-CN': {
        ...
        '上傳失敗': '上传失败', '新增失敗': '新建失败', '是否刪除 ': '是否删除 ', '刪除失敗': '删除失败'
    },
    en: {
        ...
        '可能沒有存儲權限': 'Storage permission may be missing', '載入失敗': 'Load failed', '上傳失敗': 'Upload failed',
        '新增失敗': 'Create failed', '是否刪除 ': 'Delete ', '刪除失敗': 'Delete failed'
    }
};
let locale = 'zh-TW';
