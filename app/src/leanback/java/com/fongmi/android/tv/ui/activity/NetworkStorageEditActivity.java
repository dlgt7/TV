...
public class NetworkStorageEditActivity extends BaseActivity implements NetworkInputDialog.Callback {
    ...
    protected void initEvent() {
        ...
        mBinding.insecureAuth.setOnClickListener(v -> {
            mStorage.setAllowInsecureAuth(!mStorage.isAllowInsecureAuth());
            refresh();
        });
        mBinding.smbDowngrade.setOnClickListener(v -> {
            mStorage.setAllowSmbEncryptionDowngrade(!mStorage.isAllowSmbEncryptionDowngrade());
            refresh();
        });
    ...
    private void refresh() {
        ...
        mBinding.insecureAuthText.setText(Setting.getSwitch(mStorage.isAllowInsecureAuth()));
        mBinding.smbDowngradeText.setText(Setting.getSwitch(mStorage.isAllowSmbEncryptionDowngrade()));
    }
